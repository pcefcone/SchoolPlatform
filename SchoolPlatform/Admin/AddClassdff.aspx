<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMst.Master" AutoEventWireup="true" CodeBehind="AddClass.aspx.cs" Inherits="SchoolPlatform.Admin.AddClass" %>
        ...
        <div class="container p-md-4 p-sm-4">
            ...
            <div class="row-mb-3 mr-lg-5 ml-lg-5">
                <div class="col-md-3 col-md-offset-2 mb-3">
                    <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary btn-block" BackColor="#5558C9" Text="Add Class" OnClick="buttonAdd_Click" />
                </div>
            </div>
        </div>
    </div>
